 ...
 *
 *	@since	Yanse 1
 *	Source:	wrock ( http://www.wrock.org/foundation-6-responsive-menu-walker-for-wordpress/ )
 *
 */
 function yanse_walker_menu() {

 add_theme_support( 'menus' );
 register_nav_menus(array(
 	'top-menu' => __('Top Menu' , 'yanse' ),
 	)
 );

 }
 add_action( 'after_setup_theme', 'yanse_walker_menu' );
